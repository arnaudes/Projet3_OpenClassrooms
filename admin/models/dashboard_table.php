            ...
            <tr id="commentaire_<?= $comment->id ?>">
                ...
                <td>
                    <button type="button" class="btn btn-success" data-toggle="modal"
                            data-target="#comment_validate<?= $comment->id ?>"><i class="fas fa-check"></i></button>
                    <div class="modal fade" id="comment_validate<?= $comment->id ?>" tabindex="-1" role="dialog"
                         aria-labelledby="Valider le commentaire" aria-hidden="true">
                            ...
                            <div class="modal-content" style="text-align: center">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="<?= $comment->id ?>" type="button"
                                            class="btn btn-success validate_comment" data-dismiss="modal"><i
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal"
                            data-target="#comment_delete<?= $comment->id ?>"><i class="fas fa-trash"></i></button>
                    <div class="modal fade" id="comment_delete<?= $comment->id ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content" style="text-align: center">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="<?= $comment->id ?>" type="button" class="btn btn-danger delete_comment"
