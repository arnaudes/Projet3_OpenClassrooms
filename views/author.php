    ...
    <div class="inner">
        <header class="major">
            ...
            <div class="row gtr-50 gtr-uniform">
               <div class="col-4 col-12-small" style="margin-top: 7%"><span class="image fit"><img src="images/author.jpg" alt="" /></span></div>
                <div class="col-8 col-12-small">
                    ...
                    <form id="contact-form" onsubmit="submitForm(); return false;">
                        ...
                        <button style="margin-top: 2%" class="button primary icon fa-check" type="submit" name="submit" id="contact-submit"><span id="status"> Envoyer</span></button>
                    </form>
                </div>
